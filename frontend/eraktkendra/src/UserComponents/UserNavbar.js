                ...
                <div className="flex flex-row justify-between h-16">
                    ...
                    <div className="flex flex-row items-center justify-end">
                        <div className="relative flex flex-row items-center justify-end space-x-4">
                            <div><a href='/user' className='text-white font-medium font-serif hover:text-blue-200'>Home</a></div>
                                ...
                                <div className="overflow-hidden z-10 absolute top-8 right-0 mt-2 w-36 rounded-sm shadow-lg">
                                    <div className="rounded-md bg-red-50 shadow-xs">
                                        <div className="py-1" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                                            <a href="#" className="block px-4 py-2 text-sm font-serif font-medium text-gray-700 hover:bg-red-200 hover:text-gray-900" role="menuitem">Update Profile</a>
